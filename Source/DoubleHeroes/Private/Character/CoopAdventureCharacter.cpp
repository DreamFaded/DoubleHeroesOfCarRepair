...
#include "DoubleHeroes/Public/Character/CoopAdventureCharacter.h"
...
void ACoopAdventureCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
...
void ACoopAdventureCharacter::Jump()
{
