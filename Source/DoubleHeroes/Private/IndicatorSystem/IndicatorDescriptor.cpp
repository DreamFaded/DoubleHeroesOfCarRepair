...
void UIndicatorDescriptor::SetIndicatorManagerComponent(UDoubleHeroesIndicatorManagerComponent* InManager)
{
...
{
	if (UDoubleHeroesIndicatorManagerComponent* Manager = ManagerPtr.Get())
	{
