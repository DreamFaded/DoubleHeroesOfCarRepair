...
class SWidget;
class UDoubleHeroesIndicatorManagerComponent;
class UUserWidget;
struct FFrame;
...
class DOUBLEHEROES_API UIndicatorDescriptor : public UObject
{
	GENERATED_BODY()
...
public:
	UDoubleHeroesIndicatorManagerComponent* GetIndicatorManagerComponent() { return ManagerPtr.Get(); }
	void SetIndicatorManagerComponent(UDoubleHeroesIndicatorManagerComponent* InManager);
...
private:
	...
	UPROPERTY()
	TWeakObjectPtr<UDoubleHeroesIndicatorManagerComponent> ManagerPtr;
